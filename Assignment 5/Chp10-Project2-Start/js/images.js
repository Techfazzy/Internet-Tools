...
$.each(images, function(key, value) {
    $(".gallery").append("<li id='"+value.id+"'><img src=images/square/"+value.path+" alt='"+value.title+"' /></li>");
    $("#"+value.id).mouseenter(function(){
        $("#"+value.id+" img").addClass("gray");
        $(".gallery").append("<div id='preview'><img src=images/medium/"+value.path+" alt='"+value.title+"' /><p> " +value.title +"</p> <p>"+ value.city+", "+value.country+"["+value.taken+"] </p></div>");
    ...
    $("#"+value.id).mouseleave(function(){
        $("#"+value.id+" img").removeClass("gray");
        $( "div" ).remove("#preview");
        $("#preview").css("display", "none");
       
    });
    $("#"+value.id).mousemove(function(){
        var offset = $(this).offset();
        var x =  offset.left;
        var y =  offset.top;
        $("#preview").css({top: y, left: x});
